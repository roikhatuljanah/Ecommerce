  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
	...
	<body>
		...
		<nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">
			...
			<div class="container">
				<a class="navbar-brand" href="index.php">Khat<span>.</span></a>
					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								<h1>Modern Interior 
									<span clsas="d-block">Design Studio</span></h1>
		...
		<div class="why-choose-section">
			<div class="container">
				<div class="row justify-content-between">
					<div class="col-lg-6">
						<h2 class="section-title">Alasan Anda Harus Memilih Kami</h2>
						...
						<div class="row my-5">
							...
							<div class="col-6 col-md-6">
								<div class="feature">
									...
									<h3>Mudah untuk Retur Barang</h3>
									<p>Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate.</p>
								</div>
							</div>
			...
			<div class="container">
				<div class="row justify-content-between">
					...
					<div class="col-lg-5 ps-lg-5">
						<h2 class="section-title mb-4">Kami Dapat membantumu membuat Design Interior</h2>
					...
					<div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
						<div class="product-item-sm d-flex">
							...
							<div class="pt-3">
								...
								<p><a href="<?=base_url('user/Home/shop')?>">Read More</a></p>
							</div>
						</div>
					</div>
			...
			<div class="container">
				<div class="row mb-5">
					...
					<div class="col-md-6 text-start text-md-end">
						<a href="<?= base_url('user/Home/blog')?>" class="more">View All Posts</a>
					</div>
				</div>
