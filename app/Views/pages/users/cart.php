                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td class="product-thumbnail">
                                <img src="/images/produk/<?=$pr->gambar?>" alt="Image" class="img-fluid">
                            </td>
                            <td class="product-name">
                                <h2 class="h5 text-black"><?=$pr->nama?></h2>
                            </td>
                            <td><?=$pr->harga?></td>
                            <td><?=$d->qty?></td>
                            <td><?=$pr->harga?></td>
            ...
            <div class="col-md-6">
                <div class="row mb-5">
                    <div class="col-md-6 mb-3 mb-md-0">
                        <button class="btn btn-black btn-sm" onclick="window.location='<?=base_url('user/Home/checkout')?>'">Proses Checkout</button>
                    </div>
                </div>
                <div class="row">
                </div>
