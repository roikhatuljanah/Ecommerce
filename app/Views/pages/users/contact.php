        ...
        <div class="block">
          <div class="row justify-content-center">
            ...
            <div class="col-md-8 col-lg-8 pb-4">
			  ...
			  <form action="/kontak/simpan" method="post">
                <?= csrf_field(); ?>
                <div class="row">
                  <div class="col-6">
                    <div class="form-group">
                      <label class="text-black" for="nama">First name</label>
                  ...
                  <div class="col-6">
                    <div class="form-group">
                      <label class="text-black" for="nama1">Last name</label>
                      <input type="text" class="form-control <?= ($validation->hasError('nama1')) ? 'is-invalid' : ''; ?>" id="nama1" name="nama1" value="<?= old('nama1'); ?>">
					  <div class="invalid-feedback">
                ...
                <div class="form-group mb-5">
                  ...
                  <textarea name="pesan" class="form-control<?= ($validation->hasError('pesan')) ? 'is-invalid' : ''; ?>" id="pesan" name="pesan" value="<?= old('pesan'); ?>" cols="30" rows="5"></textarea>
				  <div class="invalid-feedback">
