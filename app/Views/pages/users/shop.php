	...
	<body>
		...
		<div class="untree_co-section product-section before-footer-section">
		    <div class="container">
		      	<div class="row">
					<?php
						$isi = $mod->getAll('produk')->getResult();
						foreach($isi as $s):
					?>
		      		<!-- Start Column 1 -->
					<div class="col-12 col-md-4 col-lg-3 mb-5">
						<a class="product-item" href="<?=base_url('User/Home/simpan_keranjang/')?><?=$s->id?>">
							<img src="/images/produk/<?=$s->gambar?>" class="img-fluid product-thumbnail">
							<h3 class="product-title"><?=$s->nama?></h3>
							<strong class="product-price"><?=$s->harga?></strong>
