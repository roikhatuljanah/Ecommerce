...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"> <i class="fas fa-fw  fa-user-circle"></i> Form Tambah Testimoni</h6>
    </div>
    <div class="card-body">

        <form action="/testimoni/simpan" method="POST" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control <?= ($validation->hasError('pekerjaan')) ? 'is-invalid' : ''; ?>" id="pekerjaan" name="pekerjaan" autofocus value="<?= old('pekerjaan'); ?>">
                <div class="invalid-feedback">
